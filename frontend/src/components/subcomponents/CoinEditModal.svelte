<script lang="ts">
  ...
  {#if coin}
  <div class="modal fade" tabindex="-1" role="dialog" id="coineditmodal">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <label for="name" class="form-label m-0">Érme neve:</label>
          <input type="text" bind:value={coin.name} class="modal-title m-2" id="name" name="name" >
        ...
        <div class="modal-body">
          ...
          <label for="worth" class="form-label m-0">Becsült érték: </label>
          <input type="number" bind:value={coin.worth} class="modal-title m-2" id="worth" name="worth" >
          <hr>
