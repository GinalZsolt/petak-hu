...
<main>
    <form class="card mx-auto col-lg-6 col-md-8 col-11">
        ...
        <div class="card-body">
            ...
            <ErrorAlert bind:this={err6} Error={{id:"bademail",text:"Az email cím formátuma nem megfelelő!",error:true}}/>
            <ErrorAlert bind:this={err7} Error={{id:"badphone",text:"A telefonszám formátuma nem megfelelő!",error:true}}/>
            <div class="mb-3">
